...
public class RightManagerImpl implements RightWorkManager {
    ...
    @Override
    @Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
    public List<RightWorkInfoPO> getWorksByMIdAndState(Long mId, Long state, Integer num1, Integer num2, String time, String sort) {
    ...
    @Override
    @Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
    public List<RightWorkInfoPO> getWorksByMIdAndProcessedState(Long mId, Integer num1, Integer num2, String time, String sort) {
    ...
    @Override
    @Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
    public List<RightWorkInfoPO> getWorksByMIdAndOrderTypeAndAllProcessed(Long mId, String orderType, Integer num1, Integer num2, String time, String sort) {
    ...
    @Override
    @Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
    public List<RightWorkInfoPO> getWorksByMIdAndOrderTypeAndState(Long mId, String orderType, String state, Integer num1, Integer num2, String time, String sort) {
    ...
    @Override
    @Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
    public List<RightWorkInfoPO> getWorksByMIdAndRightTypeAndAllProcessed(Long mId, String rightType, Integer num1, Integer num2, String time, String sort) {
    ...
    @Override
    @Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
    public List<RightWorkInfoPO> getWorksByMIdAndRightTypeAndState(Long mId, String rightType, String state, Integer num1, Integer num2, String time, String sort) {
    ...
    @Override
    @Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
    public List<RightWorkInfoPO> getWorksByMIdAndRightNameAndAllProcessed(Long mId, String rightName, Integer num1, Integer num2, String time, String sort) {
    ...
    @Override
    @Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
    public List<RightWorkInfoPO> getWorksByMIdAndRightNameAndState(Long mId, String rightName, String state, Integer num1, Integer num2, String time, String sort) {
    ...
    @Override
    @Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
    public List<RightWorkInfoPO> getWorksByMIdAndRightPersonAndAllProcessed(Long mId, String rightPerson, Integer num1, Integer num2, String time, String sort) {
    ...
    @Override
    @Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
    public List<RightWorkInfoPO> getWorksByMIdAndRightPersonAndState(Long mId, String rightPerson, String state, Integer num1, Integer num2, String time, String sort) {
    ...
    @Override
    @Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
    public List<RightWorkInfoPO> getWorksByMIdAndUserTypeAndAllProcessed(Long mId, String userType, Integer num1, Integer num2, String time, String sort) {
    ...
    @Override
    @Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
    public List<RightWorkInfoPO> getWorksByMIdAndUserTypeAndState(Long mId, String userType, String state, Integer num1, Integer num2, String time, String sort) {
    ...
    @Override
    @Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
    public List<RightWorkInfoPO> getWorksByMIdAndHandlePersonAndAllProcessed(Long mId, String handlerPerson, Integer num1, Integer num2, String time, String sort) {
    ...
    @Override
    @Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
    public List<RightWorkInfoPO> getWorksByMIdAndHandlePersonAndState(Long mId, String handlerPerson, String state, Integer num1, Integer num2, String time, String sort) {
    ...
    @Override
    @Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
    public List<RightWorkInfoPO> getWorksByMIdAndTimeTypeAndAllProcessed(Long mId, String timeType, Long startTime, Long endTime, Integer num1, Integer num2, String time, String sort) {
    ...
    @Override
    @Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
    public List<RightWorkInfoPO> getWorksByMIdAndTimeTypeAndState(Long mId, String timeType, String state, Long startTime, Long endTime, Integer num1, Integer num2, String time, String sort) {
