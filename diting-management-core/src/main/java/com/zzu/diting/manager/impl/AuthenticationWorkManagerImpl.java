...
public class AuthenticationWorkManagerImpl implements AuthenticationWorkManager {
    ...
    @Override
    @Transactional(rollbackFor = Exception.class, propagation = Propagation.SUPPORTS, readOnly = true)
    public List<AuthenticationWorkInfoPO> getAllWorksByMIdAndPendingDisposalAndState(String aId, String state, Integer num1, Integer num2, String time, String sort) {
    ...
    @Override
    @Transactional(rollbackFor = Exception.class, propagation = Propagation.SUPPORTS, readOnly = true)
    public List<AuthenticationWorkInfoPO> getWorksByMIdAndPendingDisposalAndWorkIdAndState(String aId, String state, Long workId, Integer num1, Integer num2, String time, String sort) {
    ...
    @Override
    @Transactional(rollbackFor = Exception.class, propagation = Propagation.SUPPORTS, readOnly = true)
    public List<AuthenticationWorkInfoPO> getWorksByMIdAndPendingDisposalAndOrderTypeAndState(String aId, String state, String orderType, Integer num1, Integer num2, String time, String sort) {
    ...
    @Override
    @Transactional(rollbackFor = Exception.class, propagation = Propagation.SUPPORTS, readOnly = true)
    public List<AuthenticationWorkInfoPO> getWorksByMIdAndPendingDisposalAndUserIdAndState(String aId, String state, Long userId, Integer num1, Integer num2, String time, String sort) {
    ...
    @Override
    @Transactional(rollbackFor = Exception.class, propagation = Propagation.SUPPORTS, readOnly = true)
    public List<AuthenticationWorkInfoPO> getWorksByMIdAndPendingDisposalAndNicknameAndState(String aId, String state, String nickname, Integer num1, Integer num2, String time, String sort) {
    ...
    @Override
    @Transactional(rollbackFor = Exception.class, propagation = Propagation.SUPPORTS, readOnly = true)
    public List<AuthenticationWorkInfoPO> getWorksByMIdAndPendingDisposalAndRealNameAndState(String aId, String state, String realName, Integer num1, Integer num2, String time, String sort) {
    ...
    @Override
    @Transactional(rollbackFor = Exception.class, propagation = Propagation.SUPPORTS, readOnly = true)
    public List<AuthenticationWorkInfoPO> getWorksByMIdAndPendingDisposalAndUserTypeAndState(String aId, String state, String userType, Integer num1, Integer num2, String time, String sort) {
    ...
    @Override
    @Transactional(rollbackFor = Exception.class, propagation = Propagation.SUPPORTS, readOnly = true)
    public List<AuthenticationWorkInfoPO> getWorksByMIdAndPendingDisposalAndHandlePersonAndState(String aId, String state, String handlePerson, Integer num1, Integer num2, String time, String sort) {
    ...
    @Override
    @Transactional(rollbackFor = Exception.class, propagation = Propagation.SUPPORTS, readOnly = true)
    public List<AuthenticationWorkInfoPO> getWorksByMIdAndPendingDisposalAndTimeAndState(String aId, String state, String timeType, Long t1, Long t2, Integer num1, Integer num2, String time, String sort) {
    ...
    @Override
    @Transactional(rollbackFor = Exception.class, propagation = Propagation.SUPPORTS, readOnly = true)
    public List<AuthenticationWorkInfoPO> getWorksByMIdAndProcessedAndTimeAndAllState(String aId, String timeType, Long t1, Long t2, Integer num1, Integer num2, String time, String sort) {
    ...
    @Override
    @Transactional(rollbackFor = Exception.class, propagation = Propagation.SUPPORTS, readOnly = true)
    public List<AuthenticationWorkInfoPO> getWorksByMIdAndProcessedAndHandlePersonAndAllState(String aId, String handlePerson, Integer num1, Integer num2, String time, String sort) {
    ...
    @Override
    @Transactional(rollbackFor = Exception.class, propagation = Propagation.SUPPORTS, readOnly = true)
    public List<AuthenticationWorkInfoPO> getWorksByMIdAndProcessedAndUserTypeAndAllState(String aId, String userType, Integer num1, Integer num2, String time, String sort) {
    ...
    @Override
    @Transactional(rollbackFor = Exception.class, propagation = Propagation.SUPPORTS, readOnly = true)
    public List<AuthenticationWorkInfoPO> getWorksByMIdAndProcessedAndRealNameAndAllState(String aId, String realName, Integer num1, Integer num2, String time, String sort) {
    ...
    @Override
    @Transactional(rollbackFor = Exception.class, propagation = Propagation.SUPPORTS, readOnly = true)
    public List<AuthenticationWorkInfoPO> getWorksByMIdAndProcessedAndNicknameAndAllState(String aId, String nickname, Integer num1, Integer num2, String time, String sort) {
    ...
    @Override
    @Transactional(rollbackFor = Exception.class, propagation = Propagation.SUPPORTS, readOnly = true)
    public List<AuthenticationWorkInfoPO> getWorksByMIdAndProcessedAndOrderTypeAndAllState(String aId, String orderType, Integer num1, Integer num2, String time, String sort) {
