...
<script>
    ...
    $(function () {
        //初始化数据表格
        $("#dbReputationRightWorkProccesed").edatagrid({
            toolbar: "#tbReputationRightWorkProccesed",
            fitColumns: true,
            url: "${pageContext.request.contextPath}/rightWork/getTable?rightType=2&tableType=2",
