...
<script type="text/javascript">
    ...
    $(function () {
        $("#updateUserCoRightForm").form("load", "${pageContext.request.contextPath}/right/getRightDetail?type=著作权&id="+id
        )

        //定义保存按钮
        $("#confirmUpUserCoRight").linkbutton({
            iconCls: "icon-save",
            //单击保存按钮触发表单提交事件
            onClick: function () {
                //提交表单事件
...
<div>
    ...
    <form id="updateUserCoRightForm" method="post" enctype="multipart/form-data">
        <table style="display: block" id="copyright">
            <tr >
                <td>
                    <input id="id1" type="hidden" class="easyui-validatebox" name="id"
        ...
        <p>
            <a id="confirmUpUserCoRight" class="easyui-linkbutton">保存</a>
        </p>
    </form>
</div>
</body>
